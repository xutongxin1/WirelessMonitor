...
void QtMaterialTabsPrivate::QtMaterialTabsPrivate::init() {
  ...
  tabLayout->setContentsMargins(0,0,0,0);       // QT6 QGridLayout已经没有setMargin成员函数
}
...
QtMaterialTabs::QtMaterialTabs(QWidget *parent) : QWidget(parent), d_ptr(new QtMaterialTabsPrivate(this)) {
  d_func()->init();
}
...
void QtMaterialTabs::setCurrentTab(int index, bool is_emit) {
  Q_D(QtMaterialTabs);
